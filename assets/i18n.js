...
(function () {
  ...
  var DICT = {
    ru: {
      ...
      'cap.draw.hint': 'Раскрась робота, придумай ему лицо и знаки — всё это окажется на нём в аквариуме',
    ...
    en: {
      ...
      'cap.draw.clear': 'Start over',
      'cap.draw.hint': 'Colour the robot, give it a new face and some marks — all of it ends up on the robot in the aquarium',
    ...
    pl: {
      ...
      'cap.draw.fill': '🪣 Wypełnij',
      'cap.draw.erase': '⬜ Gumka',
      'cap.draw.clear': 'Od nowa',
      'cap.draw.hint': 'Pokoloruj robota, wymyśl mu twarz i znaki — wszystko to znajdzie się na nim w akwarium',
